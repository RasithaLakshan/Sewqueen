...
module.exports = {
    ...
    CPK: process.env.CAPTION_NAME === undefined ? 'Coded By t.me/Rasitha Lakshan' : process.env.CAPTION_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'Rasitha Lakshan' : process.env.OWNER_SHIP,
